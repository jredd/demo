...
var file_data = $.get('book_information.xml', function(data){
    ...
    $.each(book_list, function(index, book){
        ...
        tab_class.append(tab);
        tab_count += (index+1);


        var image_url = book.getAttribute('image');
        // setup book content
        ...
        //var author_first = $(book.getElementsByTagName('author')[0].getElementsByTagName('first')).text();
            var book_content = '<div id="tab'+(index+1)+'" class="tab_content"><h2>'+title+'</h2>' +
                '<div class="row"><div class="col-lg-6"><img src="'+image_url+'" alt="Book Cover"></div>'+
                '<div class="col-lg-6"><ul class="book_info">' +
                    ...
                    //'<li>'+''+'</li>' +
                '</ul></div></div>';
            book_content += '<div class="row"><div class="col-lg-6">' +
                            '<h3>Author Information</h3><ul class="author_info">' +
                                '<li>Author: '+author_first+' '+author_last+'</li>' +
                                '<li>Date of Birth: '+date_of_birth+'$</li>' +
                                '<li>Education: '+education_level+'</li>' +
                                '<li>Published Works: '+published_count+'</li>' +
                                '<li>Publisher: '+publisher+'</li>' +
                            '<li><h5>Author Contact Information</h5>'+
                            '<ul>' +
            ...
            book_content += '<div class="col-lg-6"><h3>Publisher Information</h3><ul class="author_info">' +
                                '<li>Published Works: '+published_count+'</li>' +
                            '<li><h5>Publisher Contact Information</h5>'+
                            '<ul>' +
        ...
        //$('.tab_container').append('<div class="col-lg-6"><img src="'+image_url+'" alt="Book Cover"></div>')
        tab_container_class.append(book_content)

    });

    tab_class.append('<li><a href="#tab'+tab_count+'">Information</a></li>');
    ...
    var list_info = '<div id="tab'+tab_count+'" class="tab_content"><h2>Book List Information</h2><ul>';
    ...
    tab_container_class.append(list_info)
    make_tabs_work();
});
